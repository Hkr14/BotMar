...
mongourl = 'mongodb+srv://Marbot:<password>@cluster0.pbfs2jx.mongodb.net/?retryWrites=true&w=majority'
client = pymongo.MongoClient(mongourl,serverSelectionTimeoutMS=5000)
maindb = client.bot['main']

antidb = redis.Redis(host='redis-17833.c261.us-east-1-4.ec2.cloud.redislabs.com', port=17833, REDIS_PASS ='W4NPZ32GHa0RDO33t6hZcDmhR9qGQryy')

BOT_USERNAME = greatmar_bot
loggp = -735069168
